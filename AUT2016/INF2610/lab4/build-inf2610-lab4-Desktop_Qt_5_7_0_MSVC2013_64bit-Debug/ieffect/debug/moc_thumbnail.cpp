...
#include "../../../inf2610-lab4-2.6/ieffect/effects/thumbnail.h"
...
const QMetaObject Thumbnail::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Thumbnail.data,
...
void *Thumbnail::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ImageEffect"))
        return static_cast< ImageEffect*>(const_cast< Thumbnail*>(this));
