...
#include "../../../inf2610-lab4-2.6/ieffect/effects/brightness.h"
...
const QMetaObject Brightness::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Brightness.data,
      qt_meta_data_Brightness,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Brightness::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ImageEffect"))
        return static_cast< ImageEffect*>(const_cast< Brightness*>(this));
