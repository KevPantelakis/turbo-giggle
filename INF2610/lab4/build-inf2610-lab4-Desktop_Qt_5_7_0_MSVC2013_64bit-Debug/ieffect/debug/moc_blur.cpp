...
#include "../../../inf2610-lab4-2.6/ieffect/effects/blur.h"
...
const QMetaObject Blur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Blur.data,
      qt_meta_data_Blur,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Blur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Blur.stringdata0))
        return static_cast<void*>(const_cast< Blur*>(this));
    if (!strcmp(_clname, "ImageEffect"))
        return static_cast< ImageEffect*>(const_cast< Blur*>(this));
