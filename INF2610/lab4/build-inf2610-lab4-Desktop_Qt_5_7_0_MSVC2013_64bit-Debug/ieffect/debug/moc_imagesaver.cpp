...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageSaver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImageSaver_t qt_meta_stringdata_ImageSaver = {
    {
QT_MOC_LITERAL(0, 0, 10), // "ImageSaver"
QT_MOC_LITERAL(1, 11, 6), // "output"
QT_MOC_LITERAL(2, 18, 4) // "QDir"

    },
    "ImageSaver\0output\0QDir"
};
...
void ImageSaver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ImageSaver *_t = static_cast<ImageSaver *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QDir*>(_v) = _t->output(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setOutput(*reinterpret_cast< QDir*>(_v)); break;
        default: break;
        }
...
const QMetaObject ImageSaver::staticMetaObject = {
    { &PipelineStage::staticMetaObject, qt_meta_stringdata_ImageSaver.data,
      qt_meta_data_ImageSaver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ImageSaver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageSaver.stringdata0))
