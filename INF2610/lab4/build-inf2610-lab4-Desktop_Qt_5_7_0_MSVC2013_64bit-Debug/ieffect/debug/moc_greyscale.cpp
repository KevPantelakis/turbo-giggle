...
#include "../../../inf2610-lab4-2.6/ieffect/effects/greyscale.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GreyScale_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GreyScale_t qt_meta_stringdata_GreyScale = {
    {
QT_MOC_LITERAL(0, 0, 9) // "GreyScale"
...
const QMetaObject GreyScale::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GreyScale.data,
      qt_meta_data_GreyScale,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GreyScale::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GreyScale.stringdata0))
