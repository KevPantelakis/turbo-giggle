...
static struct lib_def libs[] = {
	...
	},
    {
        ...
        .init = semrelay_initialization,
        .done = semrelay_destroy,
        .spawn = spawn_parallel,
        .equals = 1,
    },
	{
	  ...
	  .init = spinlock_initialization,
	  .done = spinlock_destroy,
	  .spawn = spawn_parallel,
	  .equals = 1,
	},
};
