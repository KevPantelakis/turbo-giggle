...
static struct operation ops[] = {
	{ .account = &global_account, .amount = 4,  .name = "Montreal" },
	{ .account = &global_account, .amount = 9, .name = "Toronto" },
	{ .account = &global_account, .amount = -3,  .name = "Ottawa" },
	{ .account = &global_account, .amount = -7,  .name = "Vancouver" },
        { .account = &global_account, .amount = 10,  .name = "Edmonton" },
